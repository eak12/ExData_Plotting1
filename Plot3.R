...
#7. step seven - subset only values 1/2/2007 or 2/2/2007 for the date column
...
#10. step 10 - create a posixct variable
...
#12. step 12 - create a line/time-series graph of Energy sub metering, i.e. Sub_metering_1 & Sub_metering_2 & Sub_metering_3  
#type="n" means not put data yet
with(SubsetInitial, plot(DateTime, Sub_metering_1, type = "n", 
                         xlab = "",
                         ylab = "Energy sub metering"))

#13. step 13 - add the points from Sub_metering_1 column to the line/time-series graph (see step 7)

with(SubsetInitial, points(DateTime, Sub_metering_1, type = "l"))

#14. step 14 - add the points from Sub_metering_2 column to the line/time-series graph (see step 7)

with(SubsetInitial, points(DateTime, Sub_metering_2, type = "l", col="red"))

#15. step 15 - add the points from Sub_metering_3 column to the line/time-series graph (see step 7)
...
#17. step 17 - close devise, so that png exists in working directory
